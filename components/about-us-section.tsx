        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              With over 10 years of experience in brand strategy and design, John leads our team with a passion for creating meaningful brand experiences. He believes that great design is not just about aesthetics—it's about solving real business problems and creating lasting connections with audiences.
            </p>
